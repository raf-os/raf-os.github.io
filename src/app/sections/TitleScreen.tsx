...
function TextWackyShader() {
    ...
    useEffect(() => {
        ...
        const initTexture = () => {
            ...
            handleLoadedTexture(canvasTexture, textTexture.current as HTMLCanvasElement);
        }

        const handleLoadedTexture = (texture: WebGLTexture, textureCanvas: HTMLCanvasElement) => {
